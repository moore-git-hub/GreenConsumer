...
| FIG-COG-02 | T5-to-endpoint transition heatmap | `cognition/figures/02_recovery_transition_heatmap.png` | single-run mean within-Agent change | IMPLEMENTED_NOT_RENDERED |
| FIG-COG-03 | Explicit appraisal availability | `cognition/figures/03_explicit_appraisal_availability.png` | record availability, not reasoning quality | IMPLEMENTED_NOT_RENDERED |
